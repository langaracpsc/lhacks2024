...
export default function AskedQuestions() {
    ...
    return (
        ...
        <div  className="flex flex-col max-[569px]:border-white  max-[569px]:rounded-lg max-[569px]:border-2  w-11/12 h-fit justify-center align-center gap-7 pt-4 pr-4 pb-4 pl-4">
